...
module WSDConf = struct
  type cmd = Find of int | Add of int | Remove of int
...
let () =
  ...
  QCheck_base_runner.run_tests_main
    [
      WSDT_seq.agree_test ~count ~name:"STM Lockfree.Atomicskiplist test sequential";
      WSDT_dom.agree_test_par ~count ~name:"STM Lockfree.Atomicskiplist test parallel";
       ]
