...
* [Skiplist](src/atomicskiplist.mli) A set implementation with logarithmic search. Is is based on *A lock-free concurrent skiplist with wait-free search* by M.Herlihy, Y. Lev, N. Shavit, 2007.
